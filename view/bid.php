...
if (!isset($_SESSION['user'])) {
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-7">
                <img class="img-thumbnail" alt="Bootstrap Image Preview" style="width: 100%;height: 500px"
            ...
            <div class="col-md-5">
                ...
                <dl class="dl-horizontal">
                    ...
                    $id = $_REQUEST['pid'];
                    $rr = $conn->query("SELECT * FROM addproducts WHERE pid=$id");
                    ...
                    <dt>
                        <form method="post">
                            <input name="bAmount" type="text" required class="form-control"
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        if ($bt > 0) {
                            if ($amount > $product->price) {
                                ...
                                echo "<script type='text/javascript'>alert('Amount is less than the current price!')</script>";
                            }
                        } else {
